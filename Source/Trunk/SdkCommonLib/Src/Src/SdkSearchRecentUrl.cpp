...
SdkSearchRecentUrl::SdkSearchRecentUrl()
{
}
...
void SdkSearchRecentUrl::EnumRecentUrls()
{
    HKEY hKey = NULL;
...
const vector<wstring>* SdkSearchRecentUrl::GetRecentlyUrls() const
{
    return &m_searchUrls;
}
...
void SdkSearchRecentUrl::EnumUrlValues(IN DWORD number,IN HKEY hKey)
{
...
void SdkSearchRecentUrl::QueryInfoKey(IN HKEY hKey)
{
