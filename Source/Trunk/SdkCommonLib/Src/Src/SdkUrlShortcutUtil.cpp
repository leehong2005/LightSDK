...
#include "stdafx.h"
#include "SdkUrlShortcutUtil.h"

USING_NAMESPACE_COMMON
USING_NAMESPACE_UTILITIES

SdkUrlShortcutUtil::SdkUrlShortcutUtil()
{
...
BOOL SdkUrlShortcutUtil::CreateInternetShortcut(LPCTSTR lpcsUrl, LPCTSTR lpcsFileName)
{
...
BOOL SdkUrlShortcutUtil::CreateInternetShortcut(LPCTSTR lpcsUrl, LPCTSTR lpcsFileDir, LPCTSTR lpcsFileName)
{
    HRESULT hr = S_OK;
...
BOOL SdkUrlShortcutUtil::Initialize()
{
    return SdkCommonHelper::GetKnownFolderPath(m_szFavoritePath, CSIDL_FAVORITES);
}
