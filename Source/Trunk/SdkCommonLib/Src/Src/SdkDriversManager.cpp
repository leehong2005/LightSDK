/*!
* @file SdkDriversManager.cpp
* 
* @brief This file defines class SdkDriversManager to manager system disk devices..
* 
...
SdkDriversManager::SdkDriversManager()
{
}
...
void SdkDriversManager::BeginDetect()
{
    ...
    if (ISVALIDHANDLE(hFindVolume))
    {
        ...
        do
        {
            ...
            if ( (pDriverInfo->isRemovable || pDriverInfo->isUsbDisk) &&
...
const vector<DRIVERINFO*>* SdkDriversManager::GetRemovableDrivers()
{
...
void SdkDriversManager::GetDriverInfoFromVolumeName(IN OUT DRIVERINFO *pDriverInfo)
{
    if (NULL == pDriverInfo)
    {
        return;
...
void SdkDriversManager::GetDriverInfoFromRootPath(IN OUT DRIVERINFO *pDriverInfo)
{
    if (NULL == pDriverInfo)
    {
        return;
...
void SdkDriversManager::GetDriverInfoFromUnitMask(ULONG uMask, IN OUT DRIVERINFO *pDriverInfo)
{
    if (NULL == pDriverInfo)
    {
        return;
...
TCHAR SdkDriversManager::FirstDriverFromMask(ULONG unitmask)
{
    TCHAR i = 0;
...
void SdkDriversManager::ClearDriverInfos()
{
...
BOOL SdkDriversManager::IsRemovableDriver(IN LPCTSTR lpVolumeName)
{
...
BOOL SdkDriversManager::IsUsbDisk(IN LPCTSTR lpRootPath)
{
    ...
    if (DRIVE_FIXED == uType)
    {
        ...
        {
            BYTE *pBytes = new BYTE[sizeof(STORAGE_DEVICE_DESCRIPTOR) + 512 - 1];
            PSTORAGE_DEVICE_DESCRIPTOR pDevDesc = (PSTORAGE_DEVICE_DESCRIPTOR)pBytes;
...
BOOL SdkDriversManager::IsFloppy(IN LPCTSTR lpDriverName)
{
...
BOOL SdkDriversManager::GetDisksProperty(HANDLE hDevice, PSTORAGE_DEVICE_DESCRIPTOR pDevDesc)
{
