...
#ifdef __cplusplus
#ifndef _SDKDRIVERSMANAGER_H_
#define _SDKDRIVERSMANAGER_H_
...
/*!
* @brief The SdkDriversManager class is used to get infos of system disk devices.
*/
class CLASS_DECLSPEC SdkDriversManager
{
public:
