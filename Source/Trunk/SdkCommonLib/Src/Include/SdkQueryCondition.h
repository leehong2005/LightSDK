...
#ifdef __cplusplus
#ifndef _SDKQUERYCONDITION_H_
#define _SDKQUERYCONDITION_H_
...
/*!
* @brief SdkQueryCondition class to manage searching condition.
*/
