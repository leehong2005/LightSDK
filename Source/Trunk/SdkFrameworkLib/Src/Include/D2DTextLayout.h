...
*/
class CLASS_DECLSPEC D2DTextLayout : public D2DResource, public ID2DDeviceStateChange
{
public:
    ...
    */
    void SetText(IN LPCTSTR lpText);
    ...
    */
    void GetText(IN LPTSTR lpszText, UINT32 uSize);
