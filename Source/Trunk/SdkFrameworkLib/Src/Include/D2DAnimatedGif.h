...
/*!
* @brief This file is a wrapper of SdkWICAnimatedGif class in order to make it associates with D2D.
*/
...
private:
    ...
    SdkWICAnimatedGif       *m_pWicAnimatedGif;         // SdkWICAnimatedGif instance to process GIF with WIC.
