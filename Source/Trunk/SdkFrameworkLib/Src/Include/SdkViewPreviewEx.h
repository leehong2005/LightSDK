...
#ifdef __cplusplus
#ifndef _SDKVIEWPREVIEWEX_H_
#define _SDKVIEWPREVIEWEX_H_
...
*/
class CLASS_DECLSPEC SdkViewPreviewEx : public SdkViewLayout,
...
protected:
    ...
    vector<SdkViewElement*>    m_vecFrame;                 // The frame array.
    vector<SdkViewElement*>    m_vecContent;               // The photos array.
};

END_NAMESPACE_VIEWS

#endif // _SDKVIEWPREVIEWEX_H_
#endif // __cplusplus
