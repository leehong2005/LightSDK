...
#ifdef __cplusplus
#ifndef _SDKIMAGEPREVIEWLAYOUT_H_
#define _SDKIMAGEPREVIEWLAYOUT_H_

#include "SdkViewLayout.h"
#include "SdkGifView.h"
#include "SdkTranslateAnimation.h"
#include "IImagePreviewUpdateHandler.h"
#include "IAnimationListener.h"
#include "IAnimationTimerListener.h"

BEGIN_NAMESPACE_VIEWS

class CLASS_DECLSPEC SdkImagePreviewLayout : public SdkViewLayout,
...
public:
    ...
    */
    SdkImagePreviewLayout();

    /*!
    * @brief The destructor function.
    */
    virtual ~SdkImagePreviewLayout();
    ...
    */
    void SetUpdateImageHandler(IImagePreviewUpdateHandler *pHandler);
...
protected:
    ...
    */
    void OnAnimationStart(OUT SdkAnimation *pAnimation);
    ...
    * @param pAnimation            [ /O] The animation.
    */
    void OnAnimationPlaying(OUT SdkAnimation *pAnimation);
    ...
    * @param pAnimation            [ /O] The animation.
    */
    void OnAnimationEnd(OUT SdkAnimation *pAnimation);
    ...
    * @param pAnimation            [ /O] The animation.
    */
    VOID OnAnimationTimerUpdate(OUT SdkAnimation *pAnimation);
...
private:
    ...
    */
    void LayoutView(SdkViewLayout *pLayout, SdkGifView *pImageView, FLOAT fX, FLOAT fY, FLOAT fWidth, FLOAT fHeight);
    ...
    * @param fHeight            [I/ ] The height of view.
    */
    void SetImageInfo(SdkGifView *pImageView, LPCWSTR lpFile, FLOAT fWidth, FLOAT fHeight);
    ...
    * @param pAnimation               [ /O] The animation.
    */
    void StopAnimation(OUT SdkAnimation *pAnimation);
...
private:
    ...
    SdkGifView             *m_pLastImageView;          // The last image view.
    SdkGifView             *m_pCurImageView;           // The current image view.
    SdkGifView             *m_pNextImageView;          // The current image view.
    SdkViewLayout                  *m_pLastViewLayout;         // The Last View layout
    SdkViewLayout                  *m_pCurViewLayout;          // The current layout.
    SdkViewLayout                  *m_pNextViewLayout;         // The next view layout.
    SdkViewElement                 *m_pCurrentShowView;        // The current show view.
    IImagePreviewUpdateHandler   *m_pUpdateHandler;          // The update image handler.
    SdkTranslateAnimation          *m_pLeftTranslateAnimation; // The left/right translate animation
    SdkTranslateAnimation          *m_pRightTranslateAnimation;// The left/right translate animation
    SdkTranslateAnimation          *m_pDynamicTranslate;       // The dynamic translate animation(left button up)
...
#endif // _SDKIMAGEPREVIEWLAYOUT_H_
#endif // __cplusplus
