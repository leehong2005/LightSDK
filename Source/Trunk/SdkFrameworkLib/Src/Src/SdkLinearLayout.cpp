...
SdkLinearLayout::SdkLinearLayout(): m_nOrientation(ORIENTATION_VERTICAL),
...
SdkLinearLayout::~SdkLinearLayout()
{
...
void SdkLinearLayout::OnLayout(BOOL ifChanged, FLOAT left, FLOAT top, FLOAT width, FLOAT height)
{
    ...
    if((INT32)m_vctChildren.size() > 0)
    {
            ...
            ++itor)
        {
            ...
            (*itor)->SetLayoutInfo(layoutInfo.x, layoutInfo.y, layoutInfo.width, layoutInfo.height); 
        }
    }

    SdkViewLayout::OnLayout(ifChanged, left, top, width, height);
}

//////////////////////////////////////////////////////////////////////////

void SdkLinearLayout::SetOrientation(ORIENTATION orientation)
{
...
void SdkLinearLayout::SetStyle(INT32 nStyle)
{
...
void SdkLinearLayout::SetPadding(FLOAT left, FLOAT top, FLOAT right, FLOAT bottom)
{
...
void SdkLinearLayout::SetPadding(FLOAT paddingValue)
{
...
BOOL SdkLinearLayout::MeasureChildren(LAYOUTINFO *pLayoutInfo)
{    
...
BOOL SdkLinearLayout::MeasureVertical(LAYOUTINFO *pLayoutInfo)
{
    BOOL ifContinue = FALSE;
...
BOOL SdkLinearLayout::MeasureHorizontal(LAYOUTINFO *pLayoutInfo)
{
    BOOL ifContinue = FALSE;
