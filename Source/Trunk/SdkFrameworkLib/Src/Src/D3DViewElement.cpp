...
SdkWindow* D3DViewElement::GetWindow()
{
...
void D3DViewElement::SetAnimation(SdkAnimation *pAnimation)
{
...
void D3DViewElement::SetWindow(SdkWindow *pWindow)
{
    m_pWindow = pWindow;
}
...
{
    SdkWindow* pWindow = pViewElement->GetWindow();
    if ( pWindow != NULL )
    {
