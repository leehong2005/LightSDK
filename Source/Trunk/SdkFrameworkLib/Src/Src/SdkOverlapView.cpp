...
SdkOverlapView::SdkOverlapView(): m_pBitmapRenderTarget(NULL),
                                  ...
                                  m_bottomMargin(0.0f)
{
    ...
    SetClassName(CLASSNAME_OVERLAP);
}

//////////////////////////////////////////////////////////////////////////

SdkOverlapView::~SdkOverlapView()
{
    ClearBitmap();
...
void SdkOverlapView::ClearBitmap()
{
...
void SdkOverlapView::SetStyle(OVERLAP_STYLE style)
{
...
BOOL SdkOverlapView::RemoveImage(UINT32 index)
{
...
BOOL SdkOverlapView::SetImage(IN LPCWSTR lpfileName, UINT32 uDestWidth, UINT32 uDestHeight)
{
    BOOL retVal = FALSE;
...
BOOL SdkOverlapView::SetImage(IN HBITMAP hBitmap, UINT32 uDestWidth, UINT32 uDestHeight)
{
    BOOL retVal = FALSE;
    ...
    if ( NULL != hBitmap )
    {
        D2DBitmap *pBitmap = new D2DBitmap();
        m_vctBitmaps.push_back(pBitmap);
        retVal = pBitmap->LoadFromHBITMAP(hBitmap, uDestWidth, uDestHeight);
    }
...
BOOL SdkOverlapView::SetImage(IN UINT32 uResId, IN HMODULE hModule, UINT32 uDestWidth, UINT32 uDestHeight)
{
    D2DBitmap *pBitmap = new D2DBitmap();
    m_vctBitmaps.push_back(pBitmap);
...
void SdkOverlapView::SetImageMargin(FLOAT left, FLOAT top, FLOAT right, FLOAT bottom)
{
    m_leftMargin    = left;
    m_topMaragin    = top;
    m_rightMargin   = right;
...
void SdkOverlapView::SetImageMargin(FLOAT margin)
{
    m_leftMargin    = margin;
    m_topMaragin    = margin;
...
void SdkOverlapView::OnDrawItem(ID2D1RenderTarget *pRenderTarget)
{
...
void SdkOverlapView::OnLayout(BOOL fChanged, FLOAT left, FLOAT top, FLOAT width, FLOAT height)
{
    SdkViewElement::OnLayout(fChanged, left, top, width, height);
...
void SdkOverlapView::OnD2DDeviceStateChange(D2DDevice *pDevice, DEVICE_STATECHANGE_VALUE stateVal)
{
...
void SdkOverlapView::OnD2DDeviceResize(D2DDevice *pDevice, DEVICE_STATECHANGE_VALUE stateVal)
{
    SdkViewElement::OnD2DDeviceResize(pDevice, stateVal);
...
void SdkOverlapView::OnDrawOverlap(ID2D1RenderTarget *pRenderTarget, const D2D1_RECT_F &rect)
{
...
Matrix3x2F SdkOverlapView::CombineMatrix(IN const OVERLAP_TRANSFORMINFO& transform)
{
...
void SdkOverlapView::SetupNoneStyle()
{
    int size1 = ARRAYSIZE(m_szOverlapTransforms);
...
void SdkOverlapView::SetupFirstStyle()
{
    int size1 = ARRAYSIZE(m_szOverlapTransforms);
...
void SdkOverlapView::SetupSecondStyle()
{
    int size1 = ARRAYSIZE(m_szOverlapTransforms);
...
void SdkOverlapView::SetupThirdStyle()
{
    int size1 = ARRAYSIZE(m_szOverlapTransforms);
...
BOOL SdkOverlapView::CreateCompatibleTarget(ID2D1RenderTarget *pRenderTarget)
{
...
void SdkOverlapView::SetupOverlapLayout()
{
...
D2D1_RECT_F SdkOverlapView::SetBitmapRect(const D2D1_RECT_F &rect)
{
