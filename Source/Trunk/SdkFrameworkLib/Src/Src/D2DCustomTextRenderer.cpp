/*!
* @file D2DCustomTextRenderer.cpp 
* 
* @brief This file defines the class D2DCustomTextRenderer, is used to Generation text renderer.
* 
...
#include "stdafx.h"
#include "D2DCustomTextRenderer.h"

USING_NAMESPACE_D2D

D2DCustomTextRenderer::D2DCustomTextRenderer(
...
IFACEMETHODIMP D2DCustomTextRenderer::DrawGlyphRun(__maybenull void* clientDrawingContext,
...
IFACEMETHODIMP D2DCustomTextRenderer::DrawUnderline(__maybenull void* clientDrawingContext,
                                                 FLOAT baselineOriginX,
                                                 FLOAT baselineOriginY,
...
IFACEMETHODIMP D2DCustomTextRenderer::DrawStrikethrough(__maybenull void* clientDrawingContext,
                                                     FLOAT baselineOriginX,
                                                     FLOAT baselineOriginY,
...
IFACEMETHODIMP D2DCustomTextRenderer::DrawInlineObject(__maybenull void* clientDrawingContext,
                                                    FLOAT originX,
                                                    FLOAT originY,
...
IFACEMETHODIMP_(unsigned long) D2DCustomTextRenderer::AddRef()
{
...
IFACEMETHODIMP_(unsigned long) D2DCustomTextRenderer::Release()
{
...
IFACEMETHODIMP D2DCustomTextRenderer::IsPixelSnappingDisabled(__maybenull void* clientDrawingContext,
...
IFACEMETHODIMP D2DCustomTextRenderer::GetCurrentTransform(__maybenull void* clientDrawingContext,
...
IFACEMETHODIMP D2DCustomTextRenderer::GetPixelsPerDip(__maybenull void* clientDrawingContext,
...
IFACEMETHODIMP D2DCustomTextRenderer::QueryInterface(IID const& riid,void** ppvObject)
{
    static const QITAB qit[] = 
    {
        QITABENT(D2DCustomTextRenderer, IDWriteTextRenderer),
        QITABENT(D2DCustomTextRenderer, IDWritePixelSnapping),
        QITABENT(D2DCustomTextRenderer, IUnknown),
        { 0 },
    };
