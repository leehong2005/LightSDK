...
/*!
* @brief IConfig class to defines behaviors to manage config files.
*/
class CLASS_DECLSPEC IConfig
{
public:
    ...
    * @brief Get config file path.
    *
    * @param pQueryNotify     [I/ ] The Pointer to set.
    */
    //virtual void SetQueryNotify(IQueryNotify *pQueryNotify) = 0;
