/*!
* @file PreviewHandler.h
* 
* @brief PreviewHandler class defines methods to get the preview of a specified file.
*
...
#ifdef __cplusplus
#ifndef _PREVIEWHANDLER_H_
#define _PREVIEWHANDLER_H_
...
/*!
* @brief PreviewHandler class.
*/
class CLASS_DECLSPEC PreviewHandler
{
public:
...
protected:
    ...
    HGLOBAL                         m_hGlobalMemory;                // The global memory.
