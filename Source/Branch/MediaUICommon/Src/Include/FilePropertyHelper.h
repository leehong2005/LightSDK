...
#ifdef __cplusplus
#ifndef _MEDIACONTENT_H_
#define _MEDIACONTENT_H_
...
*/
class CLASS_DECLSPEC FilePropertyHelper
{
public:
    ...
    */
    FilePropertyHelper(IN LPCWSTR lpFileName);

    /*!
    * @brief The copy constructor function.
    */
    FilePropertyHelper(const FilePropertyHelper& src);

    /*!
    * @brief The equal operator function.
    */
    FilePropertyHelper& operator = (const FilePropertyHelper& src);

    /*!
    * @brief The destructor function.
    */
    virtual ~FilePropertyHelper();
