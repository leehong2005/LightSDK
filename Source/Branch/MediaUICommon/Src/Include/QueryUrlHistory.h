...
#ifdef __cplusplus
#ifndef _QUERYURLHISTORY_H_
#define _QUERYURLHISTORY_H_
...
/*!
* @brief The QueryUrlHistory class to query url history.
*/
class CLASS_DECLSPEC QueryUrlHistory
{
public:
