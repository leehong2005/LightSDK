...
#ifdef __cplusplus
#ifndef _WICIMAGEHELPER_H_
#define _WICIMAGEHELPER_H_
...
/*!
* @brief WICImageHelper class definition.
*/
class CLASS_DECLSPEC WICImageHelper
{
public:
