/*!
* @file FilePropertyKeyHelper.cpp 
* 
...
BOOL FilePropertyKeyHelper::s_hasInitKeys = FALSE;
FilePropertyKeyHelper::KeyInfoMap FilePropertyKeyHelper::s_keyInfoMap;

//////////////////////////////////////////////////////////////////////////

BOOL FilePropertyKeyHelper::GetPropertyKey(IN PROPERTYKEYNAME keyName, OUT PROPERTYKEYINFO &keyInfo)
{
    if (!s_hasInitKeys)
    {
        InitPropertyKey();
...
void FilePropertyKeyHelper::InitPropertyKey()
{
