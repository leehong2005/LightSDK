...
#ifdef __cplusplus
#ifndef _SLIDEBASE_H_
#define _SLIDEBASE_H_
...
/*!
* @brief SlideBase class supports drag to slide and sliding animation.
*/
class CLASS_DECLSPEC SlideBase : public ViewLayout
{
public:
    ...
    *
    * @param SlideBaseEventHandler  [I/ ] The handler object.
    */
    void SetOffsetChangedHandler(SlideBaseEventHandler *pEventHandler);
...
private:
    ...
    TranslateAnimation     *m_pTransAnim;               // The translate animation.
    SlideBaseEventHandler  *m_pEventHandler;            // The event handler.
};
