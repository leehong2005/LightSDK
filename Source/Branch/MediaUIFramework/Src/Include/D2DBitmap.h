...
class CLASS_DECLSPEC D2DBitmap : public D2DResource,
...
public:
    ...
    *         that means destination bound is original bound.
    */
    BOOL LoadFromHBITMPA(HBITMAP hBitmap, UINT32 uDestWidth = 0, UINT32 uDestHeight = 0);
...
private:
    ...
    WICImageHelper      *m_pWICImageHelper;     // The pointer to WICImageHelper, used to process image file.
};
